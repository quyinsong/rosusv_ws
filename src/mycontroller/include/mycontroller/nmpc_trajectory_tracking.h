#ifndef NMPC_TRAJECTORY_TRACKING_H_
#define NMPC_TRAJECTORY_TRACKING_H_

#include <casadi/casadi.hpp>
#include <iostream>
#include <eigen3/Eigen/Dense>

class TrajectoryTrackingNMPC
{
private:
    /* data */
    // MPC参数
...
public:
    TrajectoryTrackingNMPC(int predict_step, float sample_time, std::vector<Eigen::Matrix<float,8,1>> trajectory_sequence);
    ~TrajectoryTrackingNMPC();
    //定义求解器
